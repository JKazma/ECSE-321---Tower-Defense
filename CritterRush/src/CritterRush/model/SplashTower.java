...
public class SplashTower extends Tower{
	...
	public void shoot(Critter critter)
	{
		...
		if(Math.sqrt(critPos)< range && critter.isAlive())
			{
				ProjectileManager.addProjectile(new SplashProjectile (new Point(this.getX(),this.getY()), new Point(critter.getX(),critter.getY()), damage,image,areaRadius)); //image should be updated
			}
	}
